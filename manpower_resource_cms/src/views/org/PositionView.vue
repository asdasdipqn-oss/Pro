    ...
    <el-card>
      ...
      <el-form :inline="true" :model="queryForm" class="search-form">
        <el-form-item label="部门">
          <el-select v-model="queryForm.deptId" placeholder="全部" clearable style="width: 150px">
...
import { listPosition, listPositionByDept, addPosition, updatePosition, deletePosition } from '@/api/position'
...
const fetchData = async () => {
  loading.value = true
  try {
    const res = queryForm.deptId ? await listPositionByDept(queryForm.deptId) : await listPosition(queryForm)
